    ...
    <div class="row">
      ...
      <form id="formContacto" action="CONTROLADOR/EnviarCorreo.php" method="post" novalidate>
        ...
        <div class="col-10 col-lg-6 mb-3 mx-auto">
          ...
          <input type="text" class="form-control" id="name" name="name" aria-describedby="nameHelp" placeholder="Ejemplo: Ariadna Peña López">
        ...
        <div class="col-10 col-lg-6 mb-3 mx-auto">
          ...
          <input type="text" class="form-control" id="direccion" name="direccion" aria-describedby="direccionHelp" placeholder="Ejemplo: C/ La Almadraba 5, 3ºA Segovia 40005">
        ...
        <div class="col-10 col-lg-6 mb-3 mx-auto">
          ...
          <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Ejemplo: correo@correo.com">
        ...
        <div class="col-10 col-lg-6 mb-3 mx-auto">
          ...
          <input type="textarea" class="form-control" id="mensaje" name="mensaje" aria-describedby="mensajeHelp" placeholder="Ejemplo: Les escribo para preguntarles...">
        ...
        <!-- Mensaje de error de envío (alert) -->

        <div class="col-10 col-lg-6 mb-3 mx-auto">

          <div class="alert alert-danger alert-dismissible" role="alert">
            <div> Ha habido un error de servidor al enviar tu formulario. Vuelva a intentarlo. </div> <!-- Mensaje del alert -->
