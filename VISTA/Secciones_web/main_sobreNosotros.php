    ...
    <div class="row">
      ...
      <div class="card text-bg-dark g-0">
        ...
        <div class="card-img-overlay d-flex justify-content-center align-items-center">
          <h1 class="card-title d-none d-lg-block display-1 ms-5 ps-5"> ¿Quiénes somos? </h1> <!-- Tamaño escritorio -->
          <h1 class="card-title d-lg-none display-5"> ¿Quiénes somos? </h1> <!-- Tamaño móvil -->
        </div>
      </div>
